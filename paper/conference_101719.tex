...
\centering
\begin{tikzpicture}[scale=0.07, >=Stealth]
    % Highway
    ...
    \draw[thick, purple, dashed] (55,6) -- (85,6);
    \fill[purple] (55,6) circle (1.5);
    \fill[purple] (85,6) circle (1.5);
    \node[left, purple, font=\small] at (53,6) {$p_3$};
    \node[below, purple, font=\scriptsize] at (70,4) {$t_3^p\!=\!50,\; v_3^p\!=\!1.5$};
    % PV2: [20,90], t=5, v=1.5
    \draw[thick, orange, dashed] (20,15) -- (90,15);
    \fill[orange] (20,15) circle (1.5);
    \fill[orange] (90,15) circle (1.5);
    \node[left, orange, font=\small] at (18,15) {$p_2$};
    \node[below, orange, font=\scriptsize] at (55,13) {$t_2^p\!=\!5,\; v_2^p\!=\!1.5$};
    % PV1: [15,60], t=1, v=1.5
    \draw[thick, green!60!black, dashed] (15,24) -- (60,24);
    \fill[green!60!black] (15,24) circle (1.5);
    \fill[green!60!black] (60,24) circle (1.5);
    \node[left, green!60!black, font=\small] at (13,24) {$p_1$};
    \node[below, green!60!black, font=\scriptsize] at (37.5,22) {$t_1^p\!=\!1,\; v_1^p\!=\!1.5$};
    % AV1: [10,70], C=2, t=0, v=2
    \draw[ultra thick, blue] (10,34) -- (70,34);
    \fill[blue] (10,34) circle (1.8);
    \fill[blue] (70,34) circle (1.8);
    \node[left, blue, font=\small] at (8,34) {$a_1$};
    \node[above, blue, font=\scriptsize] at (40,36) {$C_1\!=\!2,\; t_1^a\!=\!0,\; v_1^a\!=\!2$};
    % AV2: [50,95], C=2, t=22, v=2
    \draw[ultra thick, red!70!black] (50,43) -- (95,43);
    \fill[red!70!black] (50,43) circle (1.8);
    \fill[red!70!black] (95,43) circle (1.8);
    \node[left, red!70!black, font=\small] at (48,43) {$a_2$};
    \node[above, red!70!black, font=\scriptsize] at (72.5,45) {$C_2\!=\!2,\; t_2^a\!=\!22,\; v_2^a\!=\!2$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.07, >=Stealth]
    ...
    \draw[thick, blue!25] (10,34) -- (70,34);
    \draw[thick, red!25] (50,43) -- (95,43);
    % p3: UNMATCHED (time infeasible)
    \draw[thick, purple, dashed] (55,6) -- (85,6);
    \fill[purple] (55,6) circle (1.5);
    \fill[purple] (85,6) circle (1.5);
    \node[left, purple, font=\small] at (53,6) {$p_3$};
    \node[right, font=\scriptsize, text=red] at (87,6) {unmatched ($|t^a\!-\!t^p|\!>\!\tau$)};
    % p2 -> a1 on [20,70] then a2 on [70,90]: MULTI-SEGMENT
    \draw[ultra thick, blue!70] (20,15) -- (70,15);
    \node[above, font=\scriptsize, text=blue!70] at (45,17) {towed by $a_1$: $50$};
    \draw[ultra thick, red!70!black] (70,15) -- (90,15);
    \node[above, font=\scriptsize, text=red!70!black] at (82,17) {$a_2$: $20$};
    \fill[orange] (20,15) circle (1.8);
    \fill[orange] (90,15) circle (1.8);
    \node[left, orange, font=\small] at (18,15) {$p_2$};
    % Segment boundary marker
    \draw[thick, dashed, gray] (70,12.5) -- (70,18.5);
    \node[below, font=\scriptsize, gray] at (70,12) {handoff};
    % p1 -> a1 on [15,60]: TOWED (solid green)
    \draw[ultra thick, green!60!black] (15,24) -- (60,24);
    \fill[green!60!black] (15,24) circle (1.8);
    \fill[green!60!black] (60,24) circle (1.8);
    \node[left, green!60!black, font=\small] at (13,24) {$p_1$};
    \node[above, green!60!black, font=\scriptsize] at (37.5,26) {towed by $a_1$: $45$};
    % Time check annotation for p1
    \node[right, font=\scriptsize, text=green!40!black] at (62,24) {$|2.5\!-\!1| \leq \tau$\;\checkmark};
    % Legend box
    \draw[rounded corners, fill=white, draw=gray, thin] (2,36) rectangle (52,46);
    \draw[ultra thick, blue!70] (4,44) -- (14,44);
    \node[right, font=\scriptsize] at (15,44) {Towed (energy saved)};
    \draw[thick, purple, dashed] (4,40) -- (14,40);
    \node[right, font=\scriptsize] at (15,40) {Uncovered (self-driving)};
    \node[right, font=\scriptsize] at (4,37) {Total: $p_1$: 45, $p_2$: 70, $p_3$: 0};
\end{tikzpicture}
\caption{Matching result: $p_1 \!\to\! a_1$ (45), $p_2 \!\to\! a_1\!+\!a_2$ (70), $p_3$ unmatched.}
\label{fig:toymatch}
\end{subfigure}
...
\label{thm:hungarian}
At each iteration of Algorithm~\ref{alg:hungarian}, let $\mathbf{W}$ be the cost matrix constructed from the current PV states $\{(\ell_j, \hat{t}_j)\}$ and AV assignments. The call to \textsc{LinearSumAssignment}($\mathbf{W}$) returns a matching that maximizes total towed distance among all feasible one-to-one slot-to-PV assignments for that iteration.
\end{theorem}
