...
Figure~\ref{fig:toyexample} illustrates a concrete instance with 2 AVs and 3 PVs on a highway of length $L = 100$, including temporal parameters.

\begin{figure*}[htbp]
\centering
\begin{subfigure}[b]{0.48\textwidth}
\centering
\begin{tikzpicture}[scale=0.058, >=Stealth]
    % Highway
    \draw[very thick, ->] (0,0) -- (105,0);
    \node[below, font=\footnotesize] at (0,0) {$0$};
    \node[below, font=\footnotesize] at (50,0) {$50$};
    \node[below, font=\footnotesize] at (100,0) {$100$};
    ...
    \draw[ultra thick, blue] (10,20) -- (70,20);
    \fill[blue] (10,20) circle (2);
    \fill[blue] (70,20) circle (2);
    \node[left, blue, font=\footnotesize] at (8,20) {$a_1$};
    \node[above, blue, font=\tiny] at (40,21.5) {$C_1\!=\!2,\; t_1^a\!=\!0,\; v_1^a\!=\!2$};
    % AV2: [50,95], C=2, t=38, v=2
    \draw[ultra thick, red!70!black] (50,26) -- (95,26);
    \fill[red!70!black] (50,26) circle (2);
    \fill[red!70!black] (95,26) circle (2);
    \node[left, red!70!black, font=\footnotesize] at (48,26) {$a_2$};
    \node[above, red!70!black, font=\tiny] at (72.5,27.5) {$C_2\!=\!2,\; t_2^a\!=\!22,\; v_2^a\!=\!2$};
    % PV1: [15,60], t=1, v=1.5
    \draw[thick, green!60!black, dashed] (15,11) -- (60,11);
    \fill[green!60!black] (15,11) circle (1.8);
    \fill[green!60!black] (60,11) circle (1.8);
    \node[left, green!60!black, font=\footnotesize] at (13,11) {$p_1$};
    \node[below, green!60!black, font=\tiny] at (37.5,9.5) {$t_1^p\!=\!1,\; v_1^p\!=\!1.5$};
    % PV2: [20,90], t=5, v=1.5
    \draw[thick, orange, dashed] (20,6) -- (90,6);
    \fill[orange] (20,6) circle (1.8);
    \fill[orange] (90,6) circle (1.8);
    \node[left, orange, font=\footnotesize] at (18,6) {$p_2$};
    \node[below, orange, font=\tiny] at (55,4.5) {$t_2^p\!=\!5,\; v_2^p\!=\!1.5$};
    % PV3: [55,85], t=50, v=1.5
    \draw[thick, purple, dashed] (55,1) -- (85,1);
    \fill[purple] (55,1) circle (1.8);
    \fill[purple] (85,1) circle (1.8);
    \node[left, purple, font=\footnotesize] at (53,1) {$p_3$};
    \node[below, purple, font=\tiny] at (70,-0.5) {$t_3^p\!=\!50,\; v_3^p\!=\!1.5$};
\end{tikzpicture}
\caption{Problem instance: vehicle routes with entry/exit points, capacity, entry time, and speed.}
\label{fig:toysetup}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
...
\begin{tikzpicture}[scale=0.058, >=Stealth]
    ...
    \draw[thick, blue!30] (10,20) -- (70,20);
    \draw[thick, red!30] (50,26) -- (95,26);
    % p1 -> a1 on [15,60]: TOWED (solid green)
    \draw[ultra thick, green!60!black] (15,11) -- (60,11);
    \fill[green!60!black] (15,11) circle (2);
    \fill[green!60!black] (60,11) circle (2);
    \node[left, green!60!black, font=\footnotesize] at (13,11) {$p_1$};
    \node[above, green!60!black, font=\tiny] at (37.5,12.5) {towed by $a_1$: saving $= 45$};
    % Time check annotation for p1
    \node[right, font=\tiny, text=green!40!black] at (61,11) {$|2.5\!-\!1|\!=\!1.5 \leq \tau$};
    % p2 -> a1 on [20,70] then a2 on [70,90]: MULTI-SEGMENT
    \draw[ultra thick, blue!70] (20,6) -- (70,6);
    \node[above, font=\tiny, text=blue!70] at (45,7.5) {towed by $a_1$: saving $= 50$};
    \draw[ultra thick, red!70!black] (70,6) -- (90,6);
    \node[above, font=\tiny, text=red!70!black] at (82,7.5) {$a_2$: $20$};
    \fill[orange] (20,6) circle (2);
    \fill[orange] (90,6) circle (2);
    \node[left, orange, font=\footnotesize] at (18,6) {$p_2$};
    % Segment boundary marker
    \draw[thick, dashed, gray] (70,4) -- (70,9);
    \node[below, font=\tiny, gray] at (70,3.5) {handoff};
    % p3: UNMATCHED (time infeasible)
    \draw[thick, purple, dashed] (55,1) -- (85,1);
    \fill[purple] (55,1) circle (1.8);
    \fill[purple] (85,1) circle (1.8);
    \node[left, purple, font=\footnotesize] at (53,1) {$p_3$};
    \node[right, font=\tiny, text=red] at (86,1) {unmatched};
    \node[right, font=\tiny, text=red!70!black] at (86,-1) {$|t^a\!-\!t^p|\!>\!\tau$};
    % Legend box
    \draw[rounded corners, fill=white, draw=gray, thin] (2,16) rectangle (48,28);
    \node[right, font=\tiny] at (3,26) {--- Towed segment (energy saved)};
    \draw[ultra thick, blue!70] (4,26) -- (14,26);
    \node[right, font=\tiny] at (3,22.5) {- - Uncovered (self-driving)};
    \draw[thick, purple, dashed] (4,22.5) -- (14,22.5);
    \node[right, font=\tiny] at (3,19) {Total: $p_1$: 45, $p_2$: 70, $p_3$: 0};
\end{tikzpicture}
\caption{Matching result: $p_1 \to a_1$ (45 units), $p_2 \to a_1$ then $a_2$ via multi-segment (70 units), $p_3$ unmatched due to time infeasibility.}
\label{fig:toymatch}
\end{subfigure}
